package com.afeng.web.module.weixin.config;

import com.afeng.web.common.cache.JedisUtil;
import com.afeng.web.module.weixin.handler.*;
...
//                        configStorage = new WxMpRedisConfigImpl(new JedisWxRedisOps(jedisPool), a.getAppId());
                        configStorage = new WxMpRedisConfigImpl(new JedisWxRedisOps(JedisUtil.getInstance().getJedisPool()), a.getAppId());
                    } else {
