...
//		// 拷贝网络文件到文件
//		//FileUtils.copyURLToFile(new URL("http://localhost/afeng/html/index.html"), new File("D://antetype//test.html"));
//	    //列出目录下的所有文件
//	    String[] arr = org.aspectj.util.FileUtil.listFiles(new File("D://afeng"));
