package com.afeng.framework.filter;
...
import com.afeng.framework.filter.rate.RedisRateLimiter;
...
public class ApiInterceptor extends HandlerInterceptorAdapter {
     ...
     * @see com.afeng.module.app.controller.ApiTestController#authSimpleLogin(String)
     * @see com.afeng.framework.filter.AuthHandlerMethodArgumentResolver#resolveArgument
     **/
    @Override
